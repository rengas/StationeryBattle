...
Manipulator.stopAtEdge = function(items, manipulatedItemId) {
    var manipulatedItem = items[manipulatedItemId];
    ...
    if(this.checkPathCollision(items, p1, p2) === 'No Intersection') {
...
Manipulator.checkPathCollision = function(items, pathEnd1, pathEnd2) {
    var p1 = pathEnd1;
    var p2 = pathEnd2;
